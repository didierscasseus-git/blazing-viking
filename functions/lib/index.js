...
exports.nightlyCleanup = exports.onOrderUpdated = exports.onReservationCreated = exports.createStaffUser = exports.createReservation = exports.checkAvailability = exports.createPaymentIntent = void 0;
...
exports.createPaymentIntent = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const subtotal = (orderData === null || orderData === void 0 ? void 0 : orderData.subtotal) || 0; // In cents
...
exports.createStaffUser = functions.https.onCall(async (data, context) => {
    ...
    const role = (_a = requesterProfile.data()) === null || _a === void 0 ? void 0 : _a.role;
...
exports.onReservationCreated = functions.firestore
    ...
    console.log(`[EMAIL DISPATCH] To: ${contactEmail}`);
    console.log(`[EMAIL BODY] Hi ${contactName}, your table for ${date} is confirmed.`);
...
exports.onOrderUpdated = functions.firestore
    ...
    if (before.status !== after.status) {
        console.log(`[ORDER STATUS] Order ${context.params.orderId} changed from ${before.status} to ${after.status}`);
 ...
 */
exports.nightlyCleanup = functions.pubsub.schedule('every day 04:00').onRun(async (context) => {
    ...
    await batch.commit();
    console.log(`[CLEANUP] Archived ${oldResSnap.size} reservations.`);
    return null;
});
